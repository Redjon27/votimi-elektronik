        ...
        <div class="col-sm-10 col-sm-offset-1">
            ...
            <div class="card-container">
                <div class="card">
                    <div class="front">
                        <div class="cover">
                            <img src="images/sfond1.jpg"/>
                        </div>
                        <div class="user">
                            <img class="img-circle" src="images/test1.jpg"/>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h3 class="name">emeri i personit</h3>
                                <p class="profession">profesioni</p>
            ...
            <div class="card-container">
                <div class="card">
                    <div class="front">
                        ...
                        <div class="user">
                            <img class="img-circle" src="images/test2.jpg"/>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h3 class="name">emeri i personit</h3>
            ...
            <div class="card-container">
                <div class="card">
                    <div class="front">
                        ...
                        <div class="user">
                            <img class="img-square" src="images/test3.jpg"/>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h3 class="name">emeri i personit</h3>
            ...
            <div class="card-container">
                <div class="card">
                    <div class="front">
                        ...
                        <div class="user">
                            <img class="img-circle" src="images/test4.png"/>
                        </div>
                        <div class="content">
                            <div class="main">
                                <h3 class="name">emeri i personit</h3>
